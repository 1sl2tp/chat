...
const refs=[
  ...
  {name:'Banh dns 681',category:'Banh',source:'own',priority:100},
  {name:'Sua th be co',category:'Sua',source:'own',priority:100},
  {name:'Sua th be it',category:'Sua',source:'own',priority:100},
  {name:'Xx poni be',category:'Xuc xich',source:'own',priority:100},
  {name:'Xx poni to',category:'Xuc xich',source:'own',priority:100},
