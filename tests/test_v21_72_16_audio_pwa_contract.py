...
assert "RELEASE_VERSION='V21.72.29'" in policy
...
assert 'name="app-release-version" content="V21.72.29"' in source
...
assert "RELEASE_VERSION='V21.72.29'" in update
for token in [
    'version.json',
    "cache:'no-store'",
    'visibilitychange',
...
print('V21.72.29 audio/PWA contract PASS')
