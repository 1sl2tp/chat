...
def test_wide_desktop_media_and_composer_use_stable_geometry():
    ...
    assert f'{owner}#scrollRoot{{--composer-overlap-px:0px;}}' in css
    assert f'{owner}#messageWindow{{padding-bottom:0;}}' in css
    assert f'{owner}#tailRunwaySpace{{min-height:18px;}}' in css
