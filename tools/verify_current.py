...
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_69_mobile_settings_admin_parity.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_70_mobile_account_menu_keyboard.py')],check=True,cwd=ROOT)
...
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_75_message_media_surface_width_owner.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_76_thumbnail_rotate_visibility_policy.py')],check=True,cwd=ROOT)
