...
for n in [
    'runtime-id.js','audio-capture-policy.js','app.js','shell.js','call-screen-wake-lock.js','auth-session-store.js','zalo-admin-link.js','quote-client.js','admin-composer-actions.js','admin-push-controller.js',
...
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_40_directory_sidebar_geometry_swipe.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_41_directory_scroll_footer_row.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_42_admin_context_mobile_emoticon.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_43_gallery_edge_alignment.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_44_contact_tab_identity.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_45_directory_image_order_tab_polish.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_46_top_mode_switch_state_geometry.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_47_mobile_header_picker_keyboard_occlusion.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_48_contact_tab_content_width.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_49_region2_composer_menu_contract.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_50_region2_message_action_contract.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_51_region2_viewer_menu_contract.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_52_region3_work_surface_owner.py')],check=True,cwd=ROOT)
...
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_57_region3_detail_list_surface.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_58_region3_overview_table_surface.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_59_region3_mobile_dynamic_viewport.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_60_global_desktop_dynamic_viewport.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_61_mobile_account_menu_contract.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_62_profile_delete_confirm_layer.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_63_settings_modal_layer_contract.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_64_settings_modal_dynamic_viewport.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_65_profile_modal_dynamic_viewport.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_66_global_mobile_dynamic_viewport.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_67_mobile_menu_breakpoint_dismiss.py')],check=True,cwd=ROOT)
subprocess.run([sys.executable,str(ROOT/'tests'/'test_v21_72_68_mobile_hamburger_auth_contract.py')],check=True,cwd=ROOT)
