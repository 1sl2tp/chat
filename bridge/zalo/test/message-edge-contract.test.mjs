...
test('message edge authenticates bridge token and routes bridge actions',()=>{
...
test('server forwards normalized incoming messages through message gateway',()=>{
  ...
  assert.ok(server.includes('messageGateway.syncLinkedAvatars()'));
});
