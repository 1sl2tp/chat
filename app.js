...
const AppBootController={
  ...
  fail(error){
    ...
    runtimeError.textContent='V21.72.31 runtime: '+message;
    runtimeError.classList.remove('hidden');
    console.error('[ChatScreenModule V21.72.31]',error);
  },
  ready(){
    this.phase='READY';
...
/* =========================================================
   V21.72.31 VIEWPORT POLICY + CANONICAL CONVERSATION/COMPOSER SCOPE
